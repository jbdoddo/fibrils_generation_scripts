...
rotate z, -2, obj01
#
# Create the second monomer, flip it 180deg along the x-axis, then move down 9A along y-axis
...
translate [0, 0, 5], obj05
translate [0, 0, 5], obj06

# Create monomers 7 & 8

cmd.create(None, "obj05", zoom=0)
cmd.create(None, "obj06", zoom=0)
translate [0, 0, 5], obj07
translate [0, 0, 5], obj08

# Create monomers 9 & 10

cmd.create(None, "obj07", zoom=0)
cmd.create(None, "obj08", zoom=0)
translate [0, 0, 5], obj09
translate [0, 0, 5], obj10

# Create monomers 11 & 12

cmd.create(None, "obj09", zoom=0)
cmd.create(None, "obj10", zoom=0)
translate [0, 0, 5], obj11
translate [0, 0, 5], obj12

# Create monomers 13 & 14

cmd.create(None, "obj11", zoom=0)
cmd.create(None, "obj12", zoom=0)
translate [0, 0, 5], obj13
translate [0, 0, 5], obj14

# Create monomers 15 & 16

cmd.create(None, "obj13", zoom=0)
cmd.create(None, "obj14", zoom=0)
translate [0, 0, 5], obj15
translate [0, 0, 5], obj16

# Create monomers 17 & 18

cmd.create(None, "obj15", zoom=0)
cmd.create(None, "obj16", zoom=0)
translate [0, 0, 5], obj17
translate [0, 0, 5], obj18

# Create monomers 19 & 20

cmd.create(None, "obj17", zoom=0)
cmd.create(None, "obj18", zoom=0)
translate [0, 0, 5], obj19
translate [0, 0, 5], obj20
#
